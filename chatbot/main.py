...
def generate_answer(question: str, history: list[dict], chunks: list[dict], weather: dict, session_id: str = "") -> str:
    ...
    system_prompt = (
        ...
        "Si la pregunta no pertenece a ninguno de estos dos ámbitos, responde ÚNICAMENTE con: "
        "'Solo puedo ayudarte con preguntas sobre el proyecto meteo-blog o el tiempo en España.' "
        "No añadas ninguna información adicional. No respondas a la pregunta. No hagas excepciones.\n"
